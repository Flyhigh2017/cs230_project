...
class damage(imdb):
    def __init__(self, isFinish):
        imdb.__init__(self, 'damage')
        self._data_path = '/Users/anekisei/Documents/tf-faster-rcnn/data/damage'
        self.label_path = '/Users/anekisei/Documents/tf-faster-rcnn/data/damage/Annotations'
        ...
        self._classes = {'__background__': '0', 'damage': '1'}
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_damage_annotation(index)
    ...
    '''
    def _load_damage_annotation(self, index):#modify to list[matrix] in the future
