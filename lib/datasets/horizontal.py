...
class horizontal(imdb):
    def __init__(self, isFinish):
        imdb.__init__(self, 'horizontal')
        self._data_path = '/Users/anekisei/Documents/tf-faster-rcnn/data/horizontal'
        self.label_path = '/Users/anekisei/Documents/tf-faster-rcnn/data/horizontal/Annotations'
        ...
        self._classes = {'__background__': '0', 'bone': '1', 'cord': 2}
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_horizontal_annotation(index)
    ...
    '''
    def _load_horizontal_annotation(self, index):#modify to list[matrix] in the future
