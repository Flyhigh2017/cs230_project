...
#cv2.putText(im, str(scores) , (center_x , center_y + 15), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (0, 0, 255), 1, cv2.CV_AA)
...
def test_net_damage(sess, net, imdb, weights_filename, max_per_image=100, thresh=0.05):
  count = 0
  ...
  for i in range(num_images):
    ...
    cv2.imwrite("/Users/anekisei/Documents/tf-faster-rcnn/tools/save_damage/" + im_name,im)
